...
if (isset($_GET["id"])) {
    ...
    if ($registro = mysqli_fetch_assoc($resultado)) {
        ...
        $consulta_colonia = "SELECT id_colonia 
                ...
                <div class="formulario-colonia">
                    ...
                    <?php if ($id_colonia_actual): ?>
                        <button type="button" 
                                ...
                                onclick="location.href='ver_todos_gatos.php?id=<?php echo $id_colonia_actual; ?>'">
                            Volver al listado de gatos
                        </button>
                    <?php else: ?>
                        <!-- Si el gato no tiene colonia volvemos a la gestión de colonias -->
                        <button type="button" 
                                class="boton-gestion boton-confirmar" 
