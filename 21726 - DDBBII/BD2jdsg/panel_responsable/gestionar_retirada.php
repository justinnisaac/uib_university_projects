    ...
    <div class="zona-contenido">
        <div class="contenedor-difuminado">
            ...
            <h2 class="titulo-dashboard">
                Solicitar retirada en <?php echo htmlspecialchars($nombre_ayuntamiento); ?>
            </h2>

            <button class="boton-gestion" onclick="location.href='opciones_gest_retirada/visualizar_solicitudes.php'">Visualizar solicitudes anteriores</button>
...
<?php while ($gato = mysqli_fetch_assoc($resultado)):
    ...
    $id_colonia = $gato["id_colonia"]?>
                    ...
                    <tr>
                        ...
                        <td><button class="boton-mini" onclick="location.href='opciones_gest_retirada/solicitar_retirada.php?id=<?php echo $id_gato ?>&col=<?php echo $id_colonia ?>'">Solicitar retirada</button></td>
                    </tr>
<?php endwhile; ?>
<?php else: ?>
                    <tr>
