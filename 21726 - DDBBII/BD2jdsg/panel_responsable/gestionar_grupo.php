        ...
        <div class="zona-contenido">
            ...
            <div class="contenedor-difuminado">
                ...
                <tr>
                    ...
                    <td><button class="boton-mini" onclick="location.href='opciones_gest_voluntario/eliminar_voluntario.php?id=<?php echo $id_voluntario; ?>'">Eliminar</button></td>
                ...
                <div style="margin-top: 30px; text-align: center;">
                    <button class="boton-gestion" style="width: 200px;" onclick="location.href='opciones_gest_voluntario/anadir_voluntario.php'">Añadir un nuevo miembro</button>
                </div>
                <!-- Botón para volver atrás -->
                <div style="margin-top: 15px; text-align: center;">
                    <button class="boton-gestion" style="width: 200px;" onclick="location.href='principal_responsable.php'">Volver al inicio</button>
                </div>
            </div>
        </div>
    </div>
